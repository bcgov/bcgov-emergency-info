...
return [
	...
	'content'    => '
        <!-- wp:query {"queryId":1,"query":{"perPage":"6","pages":0,"offset":0,"postType":"event","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":false,"parents":[]},"displayLayout":{"type":"list"},"className":"is-style-default"} -->
        ...
        <div class="wp-block-group" style="border-top-color:var(--wp--preset--color--support-gray-02);padding-top:var(--wp--preset--spacing--20);padding-right:var(--wp--preset--spacing--20);padding-bottom:var(--wp--preset--spacing--20);padding-left:var(--wp--preset--spacing--20)"><!-- wp:mfb/meta-field-block {"fieldType":"acf","fieldName":"affected_area","hideEmpty":true,"prefix":"\u003cspan class=\u0022areoi-icon no-circle\u0022\u003e\u003ci class=\u0022text-dark bi-geo-alt\u0022\u003e\u003c/i\u003e\u003c/span\u003e\u003cb\u003eAffected area:\u003c/b\u003e","displayLayout":"inline-block","fontSize":"medium"} /-->

        <!-- wp:mfb/meta-field-block {"fieldType":"acf","fieldName":"issued_by","hideEmpty":true,"prefix":"\u003cspan class=\u0022areoi-icon no-circle\u0022\u003e\u003ci class=\u0022text-dark bi-buildings\u0022\u003e\u003c/i\u003e\u003c/span\u003e\u003cb\u003eIssued by:\u003c/b\u003e","displayLayout":"inline-block","fontSize":"medium"} /-->

        <!-- wp:mfb/meta-field-block {"fieldType":"acf","fieldName":"victim_name","hideEmpty":true,"prefix":"\u003cspan class=\u0022areoi-icon no-circle\u0022\u003e\u003ci class=\u0022text-dark bi-people\u0022\u003e\u003c/i\u003e\u003c/span\u003e\u003cb\u003eVictim:\u003c/b\u003e","displayLayout":"inline-block","fontSize":"medium"} /-->

        <!-- wp:mfb/meta-field-block {"fieldType":"acf","fieldName":"suspect_name","hideEmpty":true,"prefix":"\u003cspan class=\u0022areoi-icon no-circle\u0022\u003e\u003ci class=\u0022text-dark bi-people\u0022\u003e\u003c/i\u003e\u003c/span\u003e\u003cb\u003eSuspect:\u003c/b\u003e","displayLayout":"inline-block","fontSize":"medium"} /--></div>
        <!-- /wp:group --></div>
        <!-- /wp:group --></div>
        <!-- /wp:group --></div>
        <!-- /wp:group -->
