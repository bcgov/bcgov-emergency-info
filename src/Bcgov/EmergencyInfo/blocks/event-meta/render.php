    ...
    <div class="is-layout-constrained wp-block-group has-background" style="background-color:#d8efff">
        <div class="is-layout-flex wp-container-16 wp-block-columns is-style-constrained">
            ...
            <div class="is-layout-flow wp-block-column" style="flex-basis:33.33%">
                <?php if ( isset( $hazard_image_srcset ) ) : ?>
                    <figure class="wp-block-image size-medium has-custom-border is-style-variable-ratio"><img loading="lazy" decoding="async" width="300" height="192" data-print-width="25" alt="" class="wp-image-81" style="border-radius:0px" title="" srcset="<?php echo esc_html( $hazard_image_srcset ); ?>" sizes="(max-width: 300px) 100vw, 300px"></figure>
                <?php endif; ?>
            </div>
        </div>
    </div>
