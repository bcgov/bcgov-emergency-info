	...
	public function add_info_banner() {
		...
		if ( $query->have_posts() ) {
			while ( $query->have_posts() ) {
				...
				echo '<div id="info-banner" class="bc-gov-alertbanner alert-emergency" role="alert" aria-labelledby="info" aria-describedby="info-desc";" data-event-id="' . esc_js( $event_id ) . '"></div>';
            ...
            <script>
                (function() {
                    ...
                    var eventId = infoBanner.getAttribute("data-event-id");
                    ...
                    if (storedEventId !== eventId) {
                        infoBanner.innerHTML = `
                            <div class="container">
                                ...
                                <div class="content">
                                    <p id="info-desc">The Government of British Columbia has issued a <a href="<?php echo esc_url( $event_url ); ?>" target="_self">State of Emergency</a>.</p>
                                </div>
                                <span class="dismiss">
                        ...
                        `;
                        infoBanner.classList.remove("hide");
