### 1.0.0: July 13, 2023
* Added "hidden" option to Status ACF field to hide events from homepage while still displaying with active styles ([DESCW-1359](https://apps.itsm.gov.bc.ca/jira/browse/DESCW-1359))
